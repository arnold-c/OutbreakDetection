...
For the dynamical noise scenarios, the vaccination rate at birth was set to 85.4%, 73.8%, 50.8%, 27.9%, and 5.0% to produce equivalent mean daily noise values (to within 2 decimal places): $\Lambda = \langle \Delta I_{R} \rangle = c \cdot \langle \Delta I_{M} \rangle$.
