...
```{julia}
using JumpProcesses, StochasticDiffEq, Random, Statistics, LinearAlgebra
using DataFrames, CairoMakie, ProgressMeter
...
lines!(ax, sir_array[4, :], sir_array[1, :])
lines!(ax, sir_array[4, :], sir_array[2, :])
lines!(ax, sir_array[4, :], sir_array[3, :])
