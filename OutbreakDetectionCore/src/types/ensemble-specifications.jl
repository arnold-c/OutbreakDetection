...
function EnsembleSpecification(
    ...
    dirpath = outdir(
        ...
        "noise_latent_period_$(round(Dates.days(dynamical_noise_params.latent_period); digits = 2))",
        "noise_infectious_period_$(round(Dates.days(dynamical_noise_params.infectious_duration); digits = 2))",
